...
import { MoviesByNameState, MoviesWithTallerActress } from './types';
...
const initialTallerActressState: MoviesWithTallerActress = {
  items: [],
  status: 'idle',
};

export const tallerActress: Reducer<MoviesWithTallerActress, MovieAction> = (
